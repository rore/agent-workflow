...
**Constraints:** Preserve existing repository instructions and third-party hooks; require explicit platform trust/approval; remain repo-structure-agnostic; report pre-invocation adapter unavailability without weakening CI and fail closed after evaluation starts; avoid runtime-specific duplication where a shared evaluator suffices.
