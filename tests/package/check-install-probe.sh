...
require "templates/checkpoints/behavioral-integrity.md"
...
require "scripts/agent-workflow-runtime.py"
require "scripts/agent-workflow-runtime.sh"
require "scripts/agent-workflow-runtime.ps1"
...
require "opencode/agent-workflow.mjs"
