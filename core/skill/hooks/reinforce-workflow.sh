...
set +e
CTX="The plan is approved. Per the repository workflow, before editing any file for a non-exempt task, invoke the /agent-workflow skill now to create the Work Record, as the approved plan specifies."
